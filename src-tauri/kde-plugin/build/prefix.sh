...
export QT_PLUGIN_PATH=/usr/lib64/plugins:$QT_PLUGIN_PATH
export QML2_IMPORT_PATH=/usr/lib64/qml:$QML2_IMPORT_PATH

export QT_QUICK_CONTROLS_STYLE_PATH=/usr/lib64/qml/QtQuick/Controls.2/:$QT_QUICK_CONTROLS_STYLE_PATH
